...
- Using new recommendation campaigns
- Improved the fetch of images inside recommendation shelves.
...
- adding recommendation type visual similarity
...
- Changed recommendation campaigns to use vrn instead of ids.

## [1.6.0] - 2025-01-15

### Added

- Personalized recommendation to the product page.
- Top items recommendation to the home page.

## [1.5.0] - 2025-01-03

### Added

- Similar products recommendation to the product page.
